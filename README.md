...
Use `cargo build` and `cargo run -- --help` for local iteration while changing the CLI. If you want a locally installed binary from the workspace checkout, use `cargo install --locked --path crates/nanite-cli`.
