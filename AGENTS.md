...
- Preserve the pinned toolchain and lint posture in `Cargo.toml` (`edition = 2024`, `rust-version = 1.98`, `unsafe_code = "forbid"`); do not introduce new frameworks, build systems, or migration churn.
